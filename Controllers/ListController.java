...
public class ListController
{
    ...
    public void verLista() {
        ...
        try {
            final Result result = db.execute("MATCH (u:User) -[:LIKES]-> (m:Movie)WHERE u.name = '" + this.selectedUserName + "'" + "RETURN m.id, m.name");
            tx.success();
            if (result.hasNext()) {
                ...
                while (result.hasNext()) {
                    ...
                    button.setOnAction((EventHandler)new EventHandler<ActionEvent>() {
                        public void handle(final ActionEvent event) {
                            ...
                            ListController.access$0(ListController.this, new Main());
                            ListController.this.main.changeToSelectedMovie(ListController.this.userLoggedIn, movieId);
                        }
                    });
    ...
    static /* synthetic */ void access$0(final ListController listController, final Main main) {
        listController.main = main;
    }
}
